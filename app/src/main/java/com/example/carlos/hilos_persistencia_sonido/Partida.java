...
public class Partida extends ImageView {
    ...
    public Partida(Context contexto, int nivel_dificultad){
        ...
        Point maneja_coord=new Point(); //integra dos corrdenadas X,Y
        ...
        //construir un layout programático
        ...
        tamPelota=tam_pantY/4; //tamaño de la pelota
        ...
        acel=nivel_dificultad*(maneja_coord.y/400); //velocidad de la pelota - dificultad
